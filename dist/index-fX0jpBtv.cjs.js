...
const initRoute = async (app, options) => {
  ...
  return await Promise.resolve().then(() => require("./index-UAjOwOSd.cjs.js")).then(async (routerMethod) => {
    const routeInstance = routerMethod.setupRouter({ app, router, publicPath, asyncRoutes, basicRoutes });
    const guard = await Promise.resolve().then(() => require("./index-Dm5ydIhl.cjs.js"));
...
exports.reloadHacker = reloadHacker;
