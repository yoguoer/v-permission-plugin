...
const initRoute = async (app, options) => {
  ...
  return await Promise.resolve().then(() => require("./index-ClJ3DnKQ.js")).then(async (routerMethod) => {
    ...
    const guard = await Promise.resolve().then(() => require("./index-BUNV1m2z.js"));
...
const initStore = async (app) => {
  await Promise.resolve().then(() => index).then(async (store2) => {
...
exports.getPermissionRoutes = getPermissionRoutes;
